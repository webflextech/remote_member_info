...
# Unit tests for RemoteMemberInfo::User
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'User' do
  before do
    # run before each test
    @instance = RemoteMemberInfo::User.new
  end
  ...
  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(@instance).to be_instance_of(RemoteMemberInfo::User)
    end
  end
  ...
  describe 'test attribute "stripe_data"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
